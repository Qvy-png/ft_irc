...
/*   Updated: 2023/04/13 16:44:53 by rdel-agu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	CommandManager::_privmsgClient(std::string str, CanalManager *canalManager, Client *cli)
{
	...
	std::cout << "Client :" << cli->getNick() << " sent a private message." << std::endl;
}
...
void	CommandManager::privmsg(std::string str, Client *cli) {
	...
	std::cout << "Client :" << cli->getNick() << " sent a message." << std::endl;
}
